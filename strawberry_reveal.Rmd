...
Midterm Project:  and Chemicals</h1>
...
# Data Cleaning for  {data-background="images/bg-01.png"}
...
- redefine value as production of  
...
# Annual value of  in each state {data-background="images/bg-04.png"}

- Showing that California Florida increasingly used all kinds of chemicals on  in recent years.

```{r fig.height= 4.5}
plot1("MEASURED IN LB")
```

# Data wrangling for  and Pesticides {data-background="images/bg-01.png"}

- drop empty rows/columns, remove white space
- rename colname of Pesticide to chemical in order to match the colname in  data
...
- Bee toxins are related to larger  production values.
